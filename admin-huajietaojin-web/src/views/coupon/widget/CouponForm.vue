  ...
  <div>
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      ...
      <el-form-item v-if="form.type === 1" label="现金券金额" required>
        <el-input-number v-model.number="money" :min="5" :max="99999999" :step="10" label="现金券金额" :disabled="!editable"></el-input-number>
        <span class="tip-text">现金券金额，单位元，最低5元，可以手动输入</span>
      </el-form-item>
      ...
      <el-form-item label="是否强制分享">
        ...
        <span class="tip-text">开启强制分享后，消费者必须通过微信分享给若干好友后才能使用本卡券</span>
      </el-form-item>

      <el-form-item label="微信转发人数" prop="require_retweets" v-if="form.force_share">
        <el-input-number v-model.number="form.require_retweets" :min="1" :max="20" label="微信转发人数" :disabled="!editable"></el-input-number>
      </el-form-item>
      ...
      <el-form-item>
        <span class="tip-text">卡券使用规则每个输入框限写一条规则，每条规则允许输入128个字符，点击 `教我设置` 按钮导入模板规则</span>
      </el-form-item>
      <el-form-item>
